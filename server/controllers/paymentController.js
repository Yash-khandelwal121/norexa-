      ...
      products.forEach((product) => {
        ...
        productLinksHtml += `
          <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 24px; margin-bottom: 24px; text-align: center;">
            ${product.thumbnail ? `<img src="${product.thumbnail}" alt="${product.title}" style="max-width: 100%; height: auto; border-radius: 8px; margin-bottom: 16px; max-height: 200px; object-fit: cover;" />` : ''}
