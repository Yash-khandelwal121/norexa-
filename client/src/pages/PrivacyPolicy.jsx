    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-slate max-w-none text-slate-300 space-y-6">
          ...
          <h2 className="text-2xl font-bold text-slate-100 mt-8">1. Introduction</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-100 mt-8">2. The Data We Collect</h2>
          ...
          <h2 className="text-2xl font-bold text-slate-100 mt-8">3. How We Use Your Data</h2>
          <p>
            We will only use your personal data when the law allows us to. Most commonly, we will use your personal data in the following circumstances:
            To process and deliver your order, manage your account, and provide customer support.
          </p>

          <h2 className="text-2xl font-bold text-slate-100 mt-8">4. Data Security</h2>
          <p>
