    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-8">1. Acceptance of Terms</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-8">2. Digital Products License</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-8">3. Refunds</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-slate-800 mt-8">4. User Accounts</h2>
          <p>
